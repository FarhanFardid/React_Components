...
const FarmerRegister = () => {
    ...
    return (
        <div className="flex xl:flex-row flex-col gap-4">
            <div className="mb-0 xl:w-[60%] xl:h-auto md:w-full md:text-6xl px-12 h-[56rem] text-5xl" style={backgroundStyle}>
            ...
            <div className="flex items-center justify-center xl:w-[40%] xl:my-0 w-full md:my-8">
                <div className="bg-gradient-to-r from-lime-500 to-lime-700 border-solid rounded-2xl w-[22rem] sm:w-[30rem] md:w-[34rem] my-10 py-16">
                    <h1 className="text-center font-bold text-emerald-900 text-3xl sm:text-4xl md:text-5xl">Farmer Registration</h1>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <label><p className="mb-2 text-xl md:text-2xl"> Password:</p>
                                <div className="relative h-[2.5rem]">
                                    <input
                                        className="w-[20rem] sm:w-[24rem] md:w-[28rem] text-black"
                                    ...
                                    <button
                                        type="button"
                                        className="absolute inset-y-2 right-[1rem] sm:right-0 px-3 py-1"
                            ...
                            <label><p className="mb-2 text-xl md:text-2xl">
                                ...
                                <div className='h-[2.5rem]'>
                                    <input className="w-[20rem] sm:w-[24rem] md:w-[28rem] mb-2 text-black" type="text" value={location} placeholder="Enter your location"
                            ...
                            <label>
                                <p className="mb-2 text-xl md:text-2xl">Farm Type:</p>
                                <div className='h-[2.5rem]'>
                                    <select
