...
const FarmerRegister = () => {
  ...
  const onSubmit = (data) => {
    ...
    const farmLocation = data.location;
              ...
              .then((data) => {
                ...
                fetch("http://localhost:3000/farmers", {
                  ...
                  .then((data) => {
                    if (data.insertedId) {
                      toast.success(
                        "Farmer Info added to FarmerDB successfully"
                      );
                      reset();
                      logOut();
                      navigate("/login");
                  ...
                  .catch((error) => {
                    console.log(error);
                    toast.error("Failed to add Farmer info to FarmerDB");
                  });
              })
              .catch((error) => {
                console.log(error);
  ...
  return (
    <div>
      <Title
        main="Farmer Registration "
        sub="We are here to help farmers"
      ></Title>
      <div className="">
        <div
                    ...
                    <label>
                      ...
                      <div className="h-[2.5rem]">
                        <select
                          className="w-[20rem] md:w-[28rem] mb-2 text-black rounded-lg"
                          name="farmType"
                          {...register("farmType", { required: true })}
                        >
