      ...
      <div className="w-full md:w-[60%] mx-auto p-3 md:p-4 my-5 md:my-8  bg-white bg-opacity-70 text-black shadow-lg rounded-md ">
        ...
        <form className="mb-4 text-sm md:text-lg">
          ...
          <div className="mb-4">
            ...
            <select
            className="w-full p-2 mt-1 border border-gray-300 rounded-lg box-border"
            id="farm-type" name="farm-type" required>
          ...
          <button type="submit"   className="submit-button w-full p-3 bg-[#5a9a08] rounded-md text-white font-bold text-xs md:text-base cursor-pointer transition-colors duration-100 ease-in-out hover:bg-[#4a8206]">
            Update Profile
          </button>
        </form>
      </div>
