...
const SliderCard = ({ img, price, name }) => {
  return (
    <div className="card card-compact md:w-80 w-40 bg-green-300 shadow-xl rounded-md">
      <figure>
        <img src={img} alt="best deals Img" className="p-1 md:p-5 rounded-lg" />
      </figure>
      <div className="card-body text-center py-3">
        <h2 className="card-title font-bold  text-yellow-500 text-base md:text-2xl md:py-2 mx-auto">
          {name}
        </h2>
        <p className="py-2 md:py-3 text-xs md:text-lg">
          <span className="font-semibold text-red-800 ">Price:</span>{" "}
          <span className="font-bold text-green-700 ">{price} Tk / kg </span>
        </p>
        <div className="">
          <Link to="/products">
