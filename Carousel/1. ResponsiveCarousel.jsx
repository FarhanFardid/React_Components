// Need to install responsive-carousel from React Awesome Components
// Change the images and import from folder
  ...
  return (
    <Carousel>
      ...
      <div>
        <img src={img5} />
        <p className="legend">
          Amidst the golden hues of ripening crops, a farmer smile reflects
          the hope and promise of a fruitful season
        </p>
      </div>
      <div>
        <img src={img2} />
